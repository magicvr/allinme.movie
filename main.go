...
func main() {
	...
	mux.HandleFunc("GET /admin/parse-interface", h.GetParseInterface)
	mux.HandleFunc("PUT /admin/parse-interface", h.SetParseInterface)
	...
	mux.HandleFunc("GET /api/parse-interface", a.GetParseInterface)
